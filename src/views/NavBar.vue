...
<!--      </li>-->
      <li class="nav-item" >
        <router-link
            ...
            :to="{name:'name',params: {id: 'id'}, hash: '#inputName'}"
            exact
        >Add Names
        </router-link>
      </li>
      <li class="nav-item">
        <router-link
            active-class="active"
            class="nav-link disabled"
            :to="{name:'phone',params: {id: 'id'}, hash: '#inputPhone'}"
        >Add Phone
        </router-link>
<!--        :class="!$store.state.name  ? 'disabled': 'nav-link'"-->
      ...
      <li class="nav-item">
        <router-link
            active-class="active"
            class="nav-link disabled"
            :to="{name:'photo',params: {id: 'id'}, hash:'#photoFile'}"
        >Add Photo
        </router-link>
<!--        :class="!$store.state.phone  ? 'disabled': 'nav-link'"-->
      ...
      <li class="nav-item">
        <router-link
            active-class="active"
            class="nav-link disabled"
            :to="{name:'choose',params: {id: 'id'}, hash:'#checkChoose'}"
        >Choose
        </router-link>
